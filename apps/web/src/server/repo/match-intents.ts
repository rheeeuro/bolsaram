/**
 * 멤버가 낸 의사 저장소 (마이그레이션 0026).
 *
 * 멤버가 누르는 것은 결정이 아니라 요청이다 — 여기 행이 생기고, 주선자가 확인해야
 ...
 * 일감이고, 멤버에게는 알림 채널이 없어 주선자가 확인할 때까지 아무 일도 일어나지
...
/**
 * 멤버가 자기 화면에서 「확인 중」을 보기 위한 목록.
 *
 * 아직 확인되지 않은 것만 준다. 멤버에게 보여야 하는 것은 「지금 기다리는 중」이라는
